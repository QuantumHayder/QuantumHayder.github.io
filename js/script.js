...
var typed = new Typed(".typing", {
    strings:["","Junior CCEC Student","API Integration Engineer", "GRC Consultant", "Machine Learning Engineer"],
    typeSpeed:100,
    BackSpeed:60,
    loop:true
})
...
const navTogglerBtn = document.querySelector(".nav-toggler"),
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('send-message-btn').addEventListener('click', function(event) {
            ...
            // Prepare the data in Formspree format
            const formData = {
                name: name,
                email: email,
                subject: subject,
            ...
            fetch('https://formspree.io/f/xanwryja', {
                method: 'POST',
                headers: {
